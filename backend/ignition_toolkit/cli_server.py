...
# Loopback by default. This is a single-user desktop app whose API has no
# authentication on most routes, so binding to 0.0.0.0 exposed the credential
# vault and playbook runner to anything on the network. Pass --host explicitly
# to widen it.
@click.option("--host", default="127.0.0.1", help="Host to bind to (default: loopback only)")
